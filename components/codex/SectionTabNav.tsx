...
function getActiveSectionId(items: SectionTabItem[]): string {
...
export default function SectionTabNav({ items }: SectionTabNavProps) {
  ...
  return (
    <nav className="codex-deity-tabs" aria-label="Article sections">
      {items.map((item) => (
        <a
          key={item.id}
          href={`#${item.id}`}
