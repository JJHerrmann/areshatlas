...
- Greek/Latin prestige affixes for imperial, ceremonial, or ancient state names
...
- fewer x/sibilant flourishes unless inherited from prestige language
...
- `-la` for settlement/place
    
- `-maa` for land/region
    
- `-vere` for old settlement/clan-place feel
    
- `-küla` for village
    
- `-mäe` for hill/high place
...
- `-koda` for hall/house/chamber
    
- `-linn` for fortified town/city
    
- `-ik` / `-iku` / `-ikum` for region/material/collective texture
    
- `-lane` for people/inhabitant
    
- `-rahvas` for folk/people if you want a full ethnonym form
    

That last one is strong if you want a true dwarf-folk label without sounding like Tolkien leftovers.

## Table 1. Hebrew Triconsonantal Roots (Dwarven-Oriented Surface Forms)
...
|MLK|king, rule|melech|მალაკ?|Wait no. Use `malak`, `melak`, `molk`|
...
|PRZ|iron/metal breach feeling|paraz-ish adaptation|paraz, peres, prez|Ironworks, war-holds|
|CHY|life|chayah|haja, kaia, haya|Hearth, clan continuity|
|ETS|tree|etz|ets, etsa, etsa|Timber halls, upper settlements|

Tiny note: `j` in Estonian-ish flavor can help where elves might use `y`. So `yam` can become `jam`, `nahar` can shorten toward `nar`, etc. That gives a firmer northern feel.
...
|-küla|village|Smaller surface or outer settlements|
|-mäe|hill, on the hill|Highland towns, ridgeholds|
|-org|valley|Rift settlements, under-vales|
|-jõe|river / of the river|River places, crossings|
...
|-iku|associated region/material domain|Delves, industrial zones|
|-lane|inhabitant/person of|Singular person or demonym|
...
These stay as fossilized imperial or ceremonial forms, usually older, state-level, or religious.
...
|Petra-|Greek/Latin flavor|stone, rock|Monumental or formal stone cities|
|Chrys-|Greek|gold|Golden dynasties, treasure capitals|
|Argen-|Latin/Greek blend|silver|Silver halls, lunar states|
|-ion|Greek|formal place ending|High cities, ancient ceremonial names|
|-ium|Latin|realm, institution|States, guild domains|
|-or|Latin|ruler/formal state|Regal or hegemonic names|
|-aris|Latin|noble/adjectival|Houses, provinces|
|-polis|Greek|city|Grand prestige capital|
|-theon|Greek|sacred order|Divine complex, oath sanctuary|

For dwarves, I would use prestige prefixes less often than with elves. They should feel like old inscriptions, royal titles, or state propaganda, not the everyday speech of miners who need a bridge fixed before winter.
...
|River settlement|root + -jõe|Narjõe|
...
## Recommended First-Pass Dwarven Set
