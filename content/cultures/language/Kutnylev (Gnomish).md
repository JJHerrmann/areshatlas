...
- Greek/Latin-style prestige affixes for imperial, ceremonial, and institutional names
...
|-fi|person of, son/daughter of style ending|Singular inhabitant or learned demonym|
|-i|adjectival, of/from|Regional, civic, or cultural adjective|
|-ok|collective plural people form|Ethnic group, guildfolk, cultural people|

## Table 3. Greek / Latin Prestige Prefixes and Affixes

Use these for imperial, ceremonial, or elite gnomish naming layers.
...
## Recommended First-Pass Gnomish Set
...
A couple of naming notes so this does not drift into fake-Magyar soup:

1. Use `-var`, `-varos`, `-haz`, `-kut`, and `-szeg` as your most common civic anchors.
    
2. Use `-fold`, `-hegy`, `-volgy`, and `-viz` for broader regional and topographic names.
    
3. Use `-fi` for singular inhabitant only sparingly. It works better as a learned or formal demonym than a daily-use one.
    
4. Use `-ok` for collective people forms if you want a strong compact ethnonym.