...
> Stub character page: name, race, and class assigned by the author to complete the six-person party roster confirmed on [[Gift I]]'s page (2026-08-10) — class specifically per author direction (Punjabi Sikh → Fighter, Khalsa warrior tradition). Deliberately left minimal — personality, backstory, and build details are left open for actual play rather than authored in advance.
